  ...
  <!--//////////////////// INCLUDE THE HEADER  //////////////////////////-->
    ...
    <div class="error text-light"></div>
      <form id="signin-form" action="" method="post"  data-parsley-validate>
        ...
        <div>
        <button type="submit" name="signin" class="w-100 btn btn-primary rounded-pill mb-3 mt-3 fw-bolder">Sign in</button>
        </div>
          </form>

          <div class="d-flex justify-content-evenly">
            <p class="">Don't have an account yet? <a href="signup.php" class="text-danger fw-bold">Create one</a></p>
          </div>
